...
verus! {
    ...
    impl SnpCore {
        ...
        forall |prev: Self, cur: Self, next: Self, regs1, regs2|
            (#[trigger]cur.reg_updated(prev, regs1) &&
            #[trigger]next.reg_updated(cur, regs2)) ==>
            next.reg_updated(prev, regs1.union(regs2))
        {
            ...
            by {
                ...
                assert forall |i| !regs.contains(i)
                implies #[trigger]next.regs[i] === prev.regs[i]
                by {
