...
verus! {
    ...
    impl SnpCoreSharedMem {
        ...
        pub open spec fn inv_stage_monitor(&self) -> bool {
            &&& self.inv()
        ...
        pub open spec fn only_lock_reg_updated(&self, prev: Self, regs: Set<RegName>, locks: Set<int>) -> bool
        {
        ...
        pub open spec fn only_lock_reg_coremode_updated(
            &self, prev: Self, regs: Set<RegName>, locks: Set<int>) -> bool
        {
            &&& self.lockperms.updated_lock(&prev.lockperms, locks)
        ...
        pub proof fn lemma_update_prop(&self, cur: Self, next: Self, regs1: Set<RegName>, locks1: Set<int>, regs2: Set<RegName>, locks2: Set<int>)
        requires
...
verus! {
    ...
    impl SnpCoreConsole {
        ...
        #[verifier(inline)]
        pub open spec fn only_console_reg_coremode_updated(&self, prev: Self, regs: Set<RegName>) -> bool {
            &&& self.console.contains_key(0)
