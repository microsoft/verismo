...
verus! {
    ...
    pub open spec fn fn_vspec_euclidean_div<T1: VSpecEuclideanDiv<T2, T3>, T2, T3>() -> spec_fn(T1, T2) -> T3 {
        |v1: T1, v2: T2| VSpecEuclideanDiv::<T2, T3>::spec_euclidean_div(v1, v2)
    }

    pub open spec fn fn_vspec_euclidean_mod<T1: VSpecEuclideanMod::<T2, T3>, T2, T3>() -> spec_fn(T1, T2) -> T3 {
        |v1: T1, v2: T2| VSpecEuclideanMod::<T2, T3>::spec_euclidean_mod(v1, v2)
    }
