...
impl SpinLock {
    ...
    pub open spec fn ensures_lock(&self, oldp: LockPermToRaw, newp: LockPermToRaw, ret_perm: SnpPointsToBytes) -> bool {
    ...
    pub open spec fn ensures_lock_value<T: IsConstant + WellFormed + SpecSize + VTypeCast<SecSeqByte>>(&self, oldp: LockPermToRaw, newp: LockPermToRaw, ret_perm: SnpPointsToData<T>) -> bool {
        &&& newp === oldp.spec_set_locked(true)
        &&& ret_perm.snp() === oldp.points_to.snp()
    ...
    pub open spec fn ensures_unlock(&self, oldp: LockPermToRaw, newp: LockPermToRaw, points_to: SnpPointsToBytes) -> bool {
