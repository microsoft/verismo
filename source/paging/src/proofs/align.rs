...
pub broadcast group group_align_proofs {
    common_proofs::bits::lemma_bit_u64_not_is_sub,
    common_proofs::bits::lemma_bit_u64_shl_values,
    common_proofs::bits::lemma_bit_u64_and_mask,
    common_proofs::bits::lemma_bit_u64_and_mask_is_mod,
    common_proofs::bits::lemma_bit_u32_not_is_sub,
    common_proofs::bits::lemma_bit_u32_shl_values,
    common_proofs::bits::lemma_bit_u32_and_mask,
    common_proofs::bits::lemma_bit_u32_and_mask_is_mod,
...
mod util_align_up {
    ...
    {
        broadcast use common_proofs::bits::lemma_bit_u64_shl_values;

        let mask = (align - 1) as u64;
        let y = (x + mask) as u64;
        common_proofs::bits::lemma_bit_u64_and_mask(y, !mask);
        common_proofs::bits::lemma_bit_u64_and_mask(y, mask);
        common_proofs::bits::lemma_bit_u64_and_mask_is_mod(y, mask);
...
mod util_integer_align {
    ...
    broadcast use {vstd::group_vstd_default, crate::specs::external::external_axiom};
    ...
    impl IntegerAligned for usize {
        ...
        proof fn lemma_align_down(val: Self, align: Self, ret: Self) {
            ...
            common_proofs::bits::lemma_bit_usize_and_mask(val, mask);
            common_proofs::bits::lemma_bit_usize_and_mask(val, !mask);
            common_proofs::bits::lemma_bit_u64_and_mask(val as u64, mask as u64);
            common_proofs::bits::lemma_bit_u64_and_mask(val as u64, !sub(align as u64, 1));
        ...
        proof fn lemma_align_up(val: Self, align: Self, ret: Self) {
            ...
            common_proofs::bits::lemma_bit_usize_and_mask(r, mask);
            common_proofs::bits::lemma_bit_usize_and_mask(r, !mask);
            common_proofs::bits::lemma_bit_u64_and_mask(r as u64, mask as u64);
            common_proofs::bits::lemma_bit_u64_and_mask(r as u64, !sub(align as u64, 1));
    ...
    impl IntegerAligned for u32 {
        ...
        proof fn lemma_align_down(val: Self, align: Self, ret: Self) {
            ...
            let mask = sub(align, 1);
            common_proofs::bits::lemma_bit_u32_and_mask(val, mask);
            common_proofs::bits::lemma_bit_u32_and_mask(val, !mask);
            common_proofs::bits::lemma_bit_u64_and_mask(val as u64, mask as u64);
            common_proofs::bits::lemma_bit_u64_and_mask(val as u64, !sub(align as u64, 1));
            lemma_align_down(val as u64, align as u64);
        ...
        proof fn lemma_align_up(val: Self, align: Self, ret: Self) {
            ...
            let r = add(val, sub(align, 1));
            let ret = add(val, sub(align, 1)) & !sub(align, 1);
            common_proofs::bits::lemma_bit_u32_and_mask(r, mask);
            common_proofs::bits::lemma_bit_u32_and_mask(r, !mask);
            common_proofs::bits::lemma_bit_u64_and_mask(r as u64, mask as u64);
            common_proofs::bits::lemma_bit_u64_and_mask(r as u64, !sub(align as u64, 1));
            lemma_align_up(val as u64, align as u64);
