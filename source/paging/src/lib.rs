...
#![cfg_attr(not(verus_only), allow(dead_code, unused_imports, unused_variables))]
...
pub use arch::x86_64::reg_contract::{PagingRegisters, MSR_EFER};
...
pub use arch::x86_64::reg_contract::{
    ...
    efer_paging_precondition, efer_value, low_bits_mask_u64, paging_inv,
};
